...
export default function MainBody({ children }) {
  return (
    <div className="relative flex-1 max-w-3xl mb-10 overflow-hidden transition-colors duration-200 border border-gray-100 shadow-lg animate__animated animate__fadeIn min-h-dvh bg-[rgb(var(--gr-from))] rounded-xl dark:border-gray-800">
