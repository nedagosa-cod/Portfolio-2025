...
export default function MainBody({ children }) {
  return (
    <div className="relative flex-1 max-w-3xl overflow-hidden transition-colors duration-200 bg-white border border-gray-100 shadow-lg min-h-dvh dark:bg-gray-900 rounded-xl dark:border-gray-800">
